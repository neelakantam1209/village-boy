...
export function useDoc<T = any>(
  ...
  if(memoizedDocRef && !memoizedDocRef.__memo) {
    throw new Error(`The DocumentReference passed to useDoc for path "${memoizedDocRef.path}" was not properly memoized using useMemoFirebase. This will cause infinite render loops.`);
  }
